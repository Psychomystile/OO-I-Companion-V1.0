...
function newReport(){
 ...
 for(const r of deployedRigs())c.report.rows[r.id]={destroyed:r.battle.parts.filter(p=>p==='disabled').length>=2,exploded:false,recovery:null,pilotRecovery:null,kills:[0,0,0,0],objectives:0,search:null,equipmentDie:null,extraSearches:[],extraXP:0};
